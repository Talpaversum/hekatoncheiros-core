...
export const PRIVILEGE_CATALOG: PrivilegeDefinition[] = [
  ...
  { id: "developer.logs.read", label: "Read developer logs", description: "Read sanitized project, deployment, and runtime logs.", scope: "tenant" },
  {
    ...
    description: "Review, approve, reject, suspend, and revoke official author requests.",
    scope: "platform",
  },
  {
  ...
  {
    id: "platform.author_registry.read",
    label: "Read author registry",
    description: "Read Registry status, authors, trust state, and certificates.",
    scope: "platform",
  },
  {
    id: "platform.author_registry.keys.manage",
    label: "Manage Registry author keys",
    description: "Create Registry author records and manage their public signing keys.",
    scope: "platform",
  },
  {
    id: "platform.author_registry.certificates.issue",
    label: "Issue Registry certificates",
    description: "Issue author certificates from registered public keys.",
    scope: "platform",
  },
  {
    id: "platform.author_registry.revoke",
    label: "Revoke author trust",
    description: "Revoke authors, signing keys, certificates, and root keys.",
    scope: "platform",
  },
  {
    id: "platform.author_registry.audit.read",
