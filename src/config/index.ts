...
const envSchema = z.object({
  ...
  OFFICIAL_CATALOG_URL: z.string().default(""),
  HOSTED_BUILD_PROVIDER_URL: z.string().default(""),
  HOSTED_ARTIFACT_STORAGE_URL: z.string().default(""),
  ...
  DEVELOPER_RUNTIME_START_TIMEOUT_MS: z.coerce.number().int().min(100).optional(),
