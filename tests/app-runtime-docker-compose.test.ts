...
function testConfig(enabled: boolean): EnvConfig {
  ...
  AUTHOR_REGISTRY_APP_ID: "hekatoncheiros/author-registry",
    ...
    AUTHOR_REGISTRY_SERVICE_TOKEN: "", AUTHOR_REGISTRY_TRUSTED_JWKS_JSON: "", OFFICIAL_CATALOG_URL: "", HOSTED_BUILD_PROVIDER_URL: "", HOSTED_ARTIFACT_STORAGE_URL: "", HOSTED_RUNTIME_PROVIDER_URL: "", HOSTED_LICENSING_ISSUER_URL: "", HOSTED_LICENSING_SIGNING_KID: "", HOSTED_LICENSING_KEY_PROVIDER_TOKEN: "",
  };
}
